export default function IULogo({ className = "w-16 h-16 text-crimson-800" }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 28 34" fill="currentColor">
